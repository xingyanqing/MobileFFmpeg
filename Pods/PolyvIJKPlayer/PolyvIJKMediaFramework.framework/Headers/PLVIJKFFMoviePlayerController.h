...
/// 初始化播放器
/// @param prefixURLUrlString 切片的url前缀
/// @param pdxData pdx的body
/// @param options 播放器配置
- (id)initWithContentPrefixURLString:(NSString *)prefixURLUrlString
                            aUrlData:(NSData *)pdxData
                         withOptions:(PLVIJKFFOptions *)options;
// drm12 end
